...
//System functions
Function ulong DllGetVersion(Ref DLLVERSIONINFO pdvi) Library "comctl32.dll"
...
Function ulong GetModuleHandle(string lpModuleName) Library "kernel32" Alias for "GetModuleHandlea;ansi"
Function ulong GetProcAddress(ulong hModule, String lpProcName) Library "kernel32.dll" alias for "GetProcAddress;ansi"
Function boolean InitCommonControlsEx(ref initcommoncontrolsex lpInitCtrls) Library "comctl32.dll"
...
Function integer ToolTipMsg(ulong hWnd, ulong uMsg, ulong wParam, REF TOOLINFO ToolInfo) library "user32" Alias For "SendMessageA;ansi"
Function integer RelayMsg(ulong hWnd, ulong uMsg, ulong wParam, REF MSG Msg) library "user32" Alias For "SendMessageA;ansi"
...
Function long lstrcpy(ulong Destination, ref string Source) library "kernel32" Alias For "lstrcpyA;ansi"

Function uLong SendMessageString( uLong hwnd, uLong Msg, uLong wParam, String lpzString ) Library "user32" Alias For "SendMessageA;ansi"

Function uLong CreateFontIndirect( Ref str_Logfont lplf ) Library 'gdi32' alias for "CreateFontIndirectA;ansi"
